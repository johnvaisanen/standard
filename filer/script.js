$(document).ready(function() {
	...
	// reagera på klick på länk 
	$("#add_item").click(function(event) {
		// utan att ladda om sida
		event.preventDefault();

		// hämta ut värden ur formulär
		...
		if(first_name !== "" && last_name !== "" && age !== "" && profession !== "")
		{
			...
			"<div class=\"item_age_profession\">Age: <span class=\"span_age\">"+age+
				"</span> Email: <span class=\"span_profession\">"+profession+"</span></div>"+
			"</div>";
			...
			// sätta fokus tillbaks i formuläret
			$("#first_name").focus();
		}
